...
namespace Streamlines.ShapeFunction
{
    class QuadraticIsoPara
    {
        ...
        public QuadraticIsoPara(Point3d p1, Point3d p2, Point3d p3, Point3d p4, Point3d p5, Point3d p6, Point3d p7, Point3d p8, Vector3d u1, Vector3d u2, Vector3d u3, Vector3d u4, Vector3d u5, Vector3d u6, Vector3d u7, Vector3d u8, double poissons)
        {
            P1 = p1;
            P2 = p2;
            P3 = p3;
