...
{
    public class GH_LilyPadComponent : GH_Component
    {
        /// <summary>
        ...
        /// </summary>
        public GH_LilyPadComponent()
          : base("LilyPadComponent", "LP1",
            "Example Grasshopper Component",
            "LilyPad", "Setup")
        {
        }
        ...
        /// </summary>
        public override Guid ComponentGuid => new Guid("4d07c1ed-ccf5-43b8-854c-b0a62f559434");
    }
}